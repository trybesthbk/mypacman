...
bool monsterdie[4]={0,0,0,0};    //判定怪物是否被吃掉
float monspeed[4]={0.5,0.5,0.5,0.5};       //怪物的初始速度
float myspeed=1.5;     //主角速度
float myradius=10;    //主角初始半径
int maxpoint=106;     //豆的数量
bool speedswith=1;    //开关速度调节
...
int main(int argc, char** argv){
	...
	glutCreateWindow("Pacman - edit by hbk");
